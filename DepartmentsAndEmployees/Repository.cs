    ...
    public class Repository
    {
        ...
        public SqlConnection Connection
        {
            get
            {
                ...
                string _connectionString = "Server=DESKTOP-UV5QE8Q\\SQLEXPRESS;Database=DepartmentsAndEmployees;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
        ...
        public void AddEmployee(Employee employee)
        {
            ...
            using (SqlConnection conn = Connection)
            {
                ...
                {
                    // More string interpolation
                    cmd.CommandText = $"INSERT INTO Employee (EmployeeName) Values ('{employee.FirstName} {employee.LastName}')";
                    cmd.ExecuteNonQuery();
                }
            }
            ...
            using (SqlConnection conn = Connection)
            {
                ...
                using (SqlCommand cmd = conn.CreateCommand())
                {
                    ...
                    cmd.CommandText = @"UPDATE Employee
                                         ...
                                         WHERE Id = @id";
                    cmd.Parameters.Add(new SqlParameter("@employeeName", employee.LastName));
                    cmd.Parameters.Add(new SqlParameter("@id", id));
